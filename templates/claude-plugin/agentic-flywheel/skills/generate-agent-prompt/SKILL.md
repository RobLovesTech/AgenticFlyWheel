...
5. Treat `CHECKLIST.yaml` as canonical for task order, acceptance, and packet manifest (`packet_level`, `requirements_mode`, `delivery_surfaces`, `enabled_modules`, `omitted_modules`).
