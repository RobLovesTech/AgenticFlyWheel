...
5. Import or merge the implementation audit gate across prompts, templates, specs, validators, and host configs.
6. Propose separate migration diffs for in-progress AIPs.
7. Do not modify completed AIPs unless the user explicitly approves.
